...
const info = (msg: string) => console.info(`credential-helper: ${msg}`)
const debug = (msg: string) => console.debug(`credential-helper: ${msg}`)
const error = (msg: string, e: any) => console.error(`credential-helper: ${msg}`, e)
