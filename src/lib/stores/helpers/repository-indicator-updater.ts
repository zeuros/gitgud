...
export class RepositoryIndicatorUpdater {
  ...
  public start() {
    if (!this.running) {
      console.debug('[RepositoryIndicatorUpdater] Starting')
  ...
  private async refreshAllRepositories() {
    ...
    console.debug('[RepositoryIndicatorUpdater] Running refreshAllRepositories')
    if (this.paused) {
      console.debug(
  ...
  public stop() {
    if (this.running) {
      console.debug('[RepositoryIndicatorUpdater] Stopping')
      this.running = false
